...
gt_tab <- df_merged_long %>%
 ...
 gt()  %>%
  ...
  tab_header(
    ...
    subtitle = paste("Each respondent (n= 1220) evaluated eight distinct messages with answers ranging from 1 - 'Not hateful at all' to 5-", " 'Extremely hateful", superscript_1, "\n")
  ) %>%
  tab_spanner(
    label = "1|2|3|4|5",
    columns = 'Rating (%)'
